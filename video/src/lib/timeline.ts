...
export type View = "module" | "program" | "today" | "records" | "sound";
export type ScreenScript = { index: number; title?: string; view?: View; state?: any; cues: Cue[] };
...
export type TScreen = { ord: number; index: number; view: View; state: any; from: number; frames: number; cues: TCue[] };
